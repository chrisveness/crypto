...
describe('NIST CSRC FIPS 180-2 SHA-1 examples', function() {
    var msg1 = 'abc';
    test('FIPS 180-2 A.1', function() { Sha1.hash(msg1, { outFormat: 'hex-8' }).should.equal('a9993e36 4706816a ba3e2571 7850c26c 9cd0d89d'); });
    var msg2 = 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq';
    test('FIPS 180-2 A.2', function() { Sha1.hash(msg2, { outFormat: 'hex-8' }).should.equal('84983e44 1c3bd26e baae4aa1 f95129e5 e54670f1'); });
    const msg3 = 'a'.repeat(1000000);
    test('FIPS 180-2 A.3', function() { Sha1.hash(msg3, { outFormat: 'hex-8' }).should.equal('34aa973c d4c4daa4 f61eeb2b dbad2731 6534016f'); });
});
...
describe('NIST CSRC FIPS 180-2 SHA-256 examples', function() {
    var msg1 = 'abc';
    test('FIPS 180-2 B.1', function() { Sha256.hash(msg1, { outFormat: 'hex-8' }).should.equal('ba7816bf 8f01cfea 414140de 5dae2223 b00361a3 96177a9c b410ff61 f20015ad'); });
    var msg2 = 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq';
    test('FIPS 180-2 B.2', function() { Sha256.hash(msg2, { outFormat: 'hex-8' }).should.equal('248d6a61 d20638b8 e5c02693 0c3e6039 a33ce459 64ff2167 f6ecedd4 19db06c1'); });
    const msg3 = 'a'.repeat(1000000);
    test('FIPS 180-2 B.3', function() { Sha256.hash(msg3, { outFormat: 'hex-8' }).should.equal('cdc76e5c 9914fb92 81a1c7e2 84d73e67 f1809a48 a497200e 046d39cc c7112cd0'); });
});
